...
public class SnomedTable implements SnomedConstants {
	...
	static {
		...
		SnomedTables.add(new SnomedTable("simplerefset","der2_Refset_SimpleTYPE", 
				termDir + "Content/der2_Refset_SimpleTYPE_EDITION_DATE.txt",
		...
		SnomedTables.add(new SnomedTable("extendedmaprefset","der2_iisssccRefset_ExtendedMapTYPE", 
				refDir + "Map/der2_iisssccRefset_ExtendedMapSnapshot_EDITION_DATE.txt",
	...
	public static String getFileType(String tableType) {
		switch (tableType) {
			case (DELTA_SUFFIX) : return DELTA;
			case (SNAPSHOT_SUFFIX) : return SNAPSHOT;
			case (FULL_SUFFIX) : 
			default:return FULL;
		}
	}
